...
setEmpphoto('')
 setEmpPass('')
  ...
  return (
    ...
    <input type="file" class="form-control-file" id="exampleFormControlFile1" onChange={(e)=>setEmpphoto(e.target.files[0])}    ></input>
    <button type="submit" className="btn btn-primary btn-block mb-4"onClick={uploadimage}   >UPLOAD PHOTO</button>
  </div>
